...
- [Lesson 3: Describe software testing to anybody](Lesson-1-3.md)
- [Lesson 4: Personal reflections on structures](Lesson-1-4.md)

### Module 2 - What do software testers do?

- [Lesson 3: Personal reflections on thought techniques](Lesson-2-3.md)
- [Lesson 3: Use the 5Ws and H Framework to Challenge Assumptions](Lesson-2-3.md) - STILL TO DO
- [Lesson 4: Map key skills to essential testing tasks ](Lesson-2-4.md)

### Module 3 - The secret skill set of software testers

- [Lesson 3: Testing heuristics, mnemonics and oracles in practice](Lesson-3-3.md)
- [Lesson 5: Building your tester skills plan](Lesson-3-5.md)

### Module 4 - Testing fundamentals and techniques 

- [Lesson 1: What are testing fundamentals?](Lesson-4-1-Activities.pdf) (PDF document)
- [Lesson 3: Testing input fields: Intuitive approach to uncovering issues](Lesson-4-3.md)
- [Lesson 6: Personal experience with Personas](Lesson-4-6.md)
- [Lesson 8: Applying testing techniques: Hands-on webpage testing](Lesson-4-8.md) - STILL TO DO

### Module 5 - The struggles of software testing

- [Lesson 2: The relationship between testing and quality](Lesson-5-2.md)
- [Lesson 4: Personal reflections on metrics](Lesson-5-4.md)
- [Lesson 6: Reflection activity](Lesson-5-6.md)

### Module 6 - Risky business: The relationship between testing and risk

- [Lesson 2: What are three key questions to uncover risks in this project?](Lesson-6-2.md)
- [Lesson 3: Reflection activity](Lesson-6-3.md)
- [Lesson 4: Reflection activity](Lesson-6-4.md)
- [Lesson 5: Applying techniques](Lesson-6-5.md)
- [Lesson 7: Complete a Risk Register table](Lesson-6-7.pdf)
- [Lesson 8: A security vulnerability](Lesson-6-8.md)

### Module 7 - The complexity of software testing

- [Lesson 1: What does system thinking mean to you?](Lesson-7-1.md)
- [Lesson 2: Formulate questions to uncover how a system works](Lesson-7-2.md)
- [Lesson 3: Mapping the system](Lesson-7-3.md)
- [Lesson 4: Reflection activity](Lesson-7-4.md)
- [Lesson 5: Multiple activities on modelling](Lesson-7-5.md)
